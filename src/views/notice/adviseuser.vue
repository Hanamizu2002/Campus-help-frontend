	...
	<div class="app-container">
		<el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
			...
			<el-form-item label="公告内容" prop="noticeContent">
				<el-input v-model="queryParams.noticeContent" placeholder="请输入公告内容" clearable
					@keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item>
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
				<template slot-scope="scope">
					<el-button size="mini" type="text" icon="el-icon-edit"
						@click="handleUpdate(scope.row)">查看公告</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog :title="title" :visible.sync="open" width="743px" append-to-body>
			...
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				<el-form-item label="内容" prop="noticeContent">
					<div
						style="white-space: pre-line; padding: 0; border: 1px solid #dcdfe6; border-radius: 4px; padding: 10px; margin-bottom: 20px; max-height: 300px; overflow-y: auto;">
						{{ form.noticeContent }}
					</div>
				</el-form-item>
