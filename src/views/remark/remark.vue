	...
	<div class="app-container">
		<el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
			...
			<el-form-item label="评价人id" prop="publishId">
				<el-input v-model="queryParams.publishId" placeholder="请输入评价人id" clearable
					@keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item>
    ...
    /> -->
		...
		<el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				...
				<el-form-item label="星级" prop="star">
					<el-rate v-model="form.star" show-text @change="changeValue">
					</el-rate>
				</el-form-item>
				...
				<el-form-item label="完成人id" prop="acceptId">
					<el-input v-model="form.acceptId" placeholder="请输入送货人id" />
				</el-form-item>
				<el-form-item label="评价人id" prop="publishId">
					<el-input v-model="form.publishId" placeholder="请输入评价人id" />
				</el-form-item>
			</el-form>
