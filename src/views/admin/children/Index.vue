		...
		<el-dialog title="提示" :visible.sync="dialogVisible" width="60%">
			<el-tabs v-model="popUps" type="card">
				<el-tab-pane label="新用户" name="first">
					<el-table :data="thatDay" border style="width: 100%">
						<el-table-column fixed prop="studentId" label="学号" min-width="120">
						</el-table-column>
						<el-table-column prop="username" label="姓名" min-width="100">
						</el-table-column>
						<el-table-column prop="school.name" label="学校" min-width="160">
						</el-table-column>
				...
				<el-tab-pane label="老用户" name="second">
					<el-table :data="oldCustomers" border style="width: 100%">
						<el-table-column fixed prop="studentId" label="学号" min-width="120">
						</el-table-column>
						<el-table-column prop="username" label="姓名" min-width="100">
						</el-table-column>
