	...
	<div class="main">
		<div class="left" :style="{width:isCollapse?'64px':'200px',background:themeColor.bg,color:themeColor.color}"
			...
			<el-menu :collapse-transition="false" :collapse="isCollapse" :router="true" :default-active="$route.path"
				...
				<el-submenu index="11">
					...
					<el-menu-item index="/home/CoinConvert">
						积分兑换
					</el-menu-item>
				</el-submenu>
			</el-menu>
		...
		<div class="right"
			...
			<div class="top"
				...
				<el-menu :unique-opened="true" :default-active="activeIndex" class="el-menu-demo" mode="horizontal"
		...
		<el-drawer title="完善信息" :visible.sync="drawer" direction="rtl" closeDrawer="false" :show-close="false"
