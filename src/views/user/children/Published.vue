<template>
	<div class="content">
		<el-card class="box-card">
			...
			<el-card class="box-card" v-for="item in tasks" style="margin-top: 20px">
				...
				<el-steps :active="item.state + 1" finish-status="success">
					<el-step title="审核中" :description="item.createTime | formatDate"></el-step>
					<el-step title="发布成功" :description="item.passTime | formatDate"></el-step>
				...
				<el-collapse style="margin-top: 20px" v-model="activeNames">
					...
					<el-collapse-item title="任务奖励" name="2">
						...
						<div><i class="el-icon-coin" style="color: red;"> {{item.coin}}积分</i></div>
					</el-collapse-item>
		...
		<el-drawer title="接受人信息" :visible.sync="drawer" direction="rtl">
